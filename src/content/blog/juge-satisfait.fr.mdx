...
Il faut que je dise comment je vis, parce que le billet ne tient pas sans ça. Mon métier, c'est data scientist dans l'aéronautique : détecter des traînées de condensation par apprentissage automatique, modéliser une trajectoire d'avion, des questions qui n'arrivent jamais avec leur critère de réussite tout prêt. Il faut le fabriquer, parfois image après image, en montant des campagnes de labellisation pour apprendre au modèle ce qu'il doit voir. Et sur mon temps libre, je construis l'exact inverse : tout un écosystème d'outils qui, eux, ne font que vérifier des réponses déjà connues. Deux activités opposées, et c'est à leur frontière que se joue l'histoire qui suit.
...
Et ce qui me dérange, c'est *qui* a trouvé la falaise. Aucun de mes gardes-fous, mais leur exact contraire : ce pilotage sans laisse que je passe mon temps libre à condamner. Mes outils vérifient des réponses. Ils ne savent pas chercher une question. Ce sont deux métiers, et je n'en avais outillé qu'un.
