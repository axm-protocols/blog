...
Je maintiens chaque mot de cette règle. Simplement, je ne la crois plus suffisante. Voici pourquoi.
...
Je suis data scientist dans l'aéronautique. Détecter des traînées de condensation par apprentissage automatique, modéliser une trajectoire d'avion : aucune de ces questions n'arrive avec son critère de réussite tout prêt. Il faut le fabriquer, parfois image après image, en montant des campagnes de labellisation pour apprendre au modèle ce qu'il doit voir.
